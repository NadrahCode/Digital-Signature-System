                    ...
                    <div class="contact-info">
                        ...
                        <div class="contact-item">
                            ...
                            <a href="tel:+60178700689">
                                <i class="bi bi-telephone"></i> +60 17-0000000
                            </a>
                        </div>
                        <div class="contact-item">
                            <h5>Email</h5>
                            <a href="mailto:sekolah-108-cm1@moe-dl.edu.my">
                                <i class="bi bi-envelope"></i> sekolah-108-cm1@moe-dl.edu.my CHANGE
                            </a>
                        </div>
                        <div class="contact-item">
                            <h5>Follow Us</h5>
                            <div class="social-links">
                                <a href="https://www.facebook.com/people/Sek-Keb-Pengkalan-Tentera-Darat/100066372350466/" target="_blank">
                                    <i class="bi bi-facebook"></i>
                                </a>
                                <a href="https://www.instagram.com/skptdrasmi/" target="_blank">
                        ...
                        <div class="contact-item">
                            <h5>Documentation</h5>
                            <a href="pdf/HELP FOR USERS.pdf" target="_blank">
                                <i class="bi bi-file-earmark-pdf"></i> User Manual
                            </a>
                            <br>
                            <a href="pdf/HELP FOR ADMIN.pdf" target="_blank" class="mt-1">
