            ...
            <div class="container">
                <div class="faq-list" id="faq-list">
                    ...
                    <div class="faq-item" data-question="What is a digital signature?">
                        ...
                        <div class="faq-answer">
                            <div class="answer-content">
                                ...
                                <p>Our system uses public key infrastructure (PKI) technology to create digital signatures.</p>
                            </div>
                        </div>
                    </div>

                    <!-- FAQ Item 2 -->
                    <div class="faq-item" data-question="Is digital signature legally binding?">
                        <button class="faq-question">
                            <div class="question-content">
                                <span class="question-number">02</span>
                                <h3 class="question-text">Are digital signatures legally binding and compliant?</h3>
                            </div>
                            <span class="arrow-icon"><i class="bi bi-chevron-down"></i></span>
                        </button>
                        <div class="faq-answer">
                            <div class="answer-content">
                                <p>Yes, digital signatures created with our platform are legally binding in most countries.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="faq-item" data-question="What file formats are supported?">
                        ...
                        <div class="faq-answer">
                            <div class="answer-content">
                                <p>Our platform supports PDF, DOC, DOCX, XLS, XLSX, PPT, PPTX, JPG, PNG, and more.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="faq-item" data-question="How do I get started?">
                        ...
                        <div class="faq-answer">
                            <div class="answer-content">
                                <p>Getting started is simple: create an account, verify your identity, generate keys, and start signing.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="faq-item" data-question="What happens if I lose access?">
                        ...
                        <div class="faq-answer">
                            <div class="answer-content">
                                <p>We offer password recovery, backup codes, security questions, and support team assistance.</p>
                            </div>
                        </div>
                    </div>

                    <!-- FAQ Item 8 -->
                    <div class="faq-item" data-question="How much does it cost?">
                        <button class="faq-question">
                            <div class="question-content">
                                <span class="question-number">08</span>
                                <h3 class="question-text">How much does the Digital Signature System cost?</h3>
                            </div>
                            <span class="arrow-icon"><i class="bi bi-chevron-down"></i></span>
                        </button>
                        <div class="faq-answer">
                            <div class="answer-content">
                                <p>We offer Free, Personal Pro ($9.99/month), Business ($29.99/month/user), and Enterprise plans.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="faq-item" data-question="Do you offer integration?">
                        ...
                        <div class="faq-answer">
                            <div class="answer-content">
                                <p>Yes, we provide REST API, webhooks, SDKs, and pre-built integrations.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="faq-item" data-question="What support do you offer?">
                        ...
                        <div class="faq-answer">
                            <div class="answer-content">
                                <p>24/7 support, knowledge base, video tutorials, webinars, and documentation.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="text-center mt-5">
                    <p class="mb-3" style="font-size: 1.2rem; color: #666;">
                        Still have questions?
                    </p>
                    <a href="queries.php" class="btn">
